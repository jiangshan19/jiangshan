...
<div class="Inside_pages clearfix">
    <div class="right_style">
        <div class="title_style"><em></em>新闻资讯</div>
                ...
                <div class="Bulletin_list">
                    <ul class="list">
                        ...
                        <li class="Bulletin_content">
                            <p class="Bulletin_time">发布时间：<%=pagelist2.get(4).toString()%></p>
                            <p><a href="<%=basePath%>xwinfo.jsp?id=<%=pagelist2.get(0).toString()%>"><%=pagelist2.get(1).toString()%></a>&nbsp;&nbsp;&nbsp;
                                来源：<%=pagelist2.get(2).toString()%></p>
                            <p class="Bulletin_btn"><a href="<%=basePath%>xwinfo.jsp?id=<%=pagelist2.get(0).toString()%>" class="Modify_cz">查看</a></p>
                        </li>
                        <%}%>
                    </ul>
                    <div class="Paging">
