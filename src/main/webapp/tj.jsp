    ...
    <div class="p_list  clearfix">
        <ul>
            <%
                ...
                int cou = cb.getMessageCount("select count(*) from cp where sxj='上架' and tj='是'");//得到信息总数
                ...
                List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from cp where sxj='上架' and tj='是' order by id desc",13);
