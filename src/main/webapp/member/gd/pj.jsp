...
<script  language="javascript" >
    function top2(){
        form3.action="<%=basePath%>member/gd/pj.jsp?page=1";
        form3.submit();
    }
    function last2(){
        if(form3.pageCount.value==0){//如果总页数为0，那么最后一页为1，也就是第一页，而不是第0页
            ...
            form3.action="<%=basePath%>member/gd/pj.jsp?page="+form3.pageCount.value;
            form3.submit();
        }
    }
    function pre2(){
        ...
        if(page<=1){
            ...
            form3.action="<%=basePath%>member/gd/pj.jsp?page="+(page-1);
            form3.submit();
        }
    }
    ...
    function bjump2(){
        ...
        if(form3.busjump.value>pageCount){//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
            if(pageCount==0){
                ...
                form3.action="<%=basePath%>member/gd/pj.jsp?page="+pageCount;
                form3.submit();
            }
        }
            ...
            if(page==0){
                ...
                form3.action="<%=basePath%>member/gd/pj.jsp?page="+page;
                form3.submit();
            }else{
                form3.action="<%=basePath%>member/gd/pj.jsp?page="+page;
                form3.submit();
            ...
            <div class="table">
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <%
                        ...
                        int cou = cb.getMessageCount("select count(*) from gwc where pf !='暂无' and gys='"+member+"'");//得到信息总数
                        ...
                        List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from gwc where pf !='暂无' and gys='"+member+"' order by id desc",14);
                    ...
                    <tr>
                        ...
                        <td><a href="<%=basePath%>member/gd/pj2.jsp?gwcid=<%=pagelist2.get(0).toString()%>">评价</a></td>
                    </tr>
                    <% } %>
                </table>
                </form>
