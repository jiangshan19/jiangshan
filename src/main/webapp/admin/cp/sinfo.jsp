...
<div id="container">
    ...
    <div id="bd">
        <div id="main">
            <form name="sform" action="<%=basePath%>admin/cp/sinfo.jsp" method="post">
            ...
            <div class="table">
                ...
                <form action="<%=basePath%>cp/batchDel2" method="post" name="form1">
                    ...
                    <%
                        ...
                        int cou = cb.getMessageCount("select count(*) from cp where mc like '%"+mc+"%' and fl like '%"+fl+"%' ");//得到信息总数
                        ...
                        List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from cp where mc like '%"+mc+"%' and fl like '%"+fl+"%' order by id desc",16);
                    ...
                    %>
                        <tr>
                            ...
                            <td>
                                <a href="<%=basePath%>admin/cp/add.jsp?method=upcp&id=<%=pagelist2.get(0).toString()%>">推荐</a>
                                <a onclick="if (confirm('确定要删除吗？')) return true; else return false;" href="<%=basePath%>cp/del2/<%=pagelist2.get(0).toString()%>">删除</a>
                            </td>
                        </tr>
                        <% } %>
                    </table>
