...
<div id="container">
    ...
    <div id="bd">
        <div id="main">
            <form name="sform" action="<%=basePath%>admin/system/sinfo.jsp" method="post">
                <div class="search-box ue-clear">
                    ...
                    <div class="search-area">
                        <div class="kv-item ue-clear">
                            <label>姓名：</label>
                            <input type="text" name="realname" style="width:150px; height:30px;" />
                        </div>
                    </div>
                    <div class="search-area">
                        <div class="kv-item ue-clear">
                            <label>联系电话：</label>
                            <input type="text" name="tel" style="width:150px; height:30px;" />
                        </div>
                    </div>
            ...
            <div class="table">
                <div class="opt ue-clear">
                	<span class="optarea">
                        <a href="<%=basePath%>admin/system/add.jsp?method=addm" class="add">
                            <i class="icon"></i>
                ...
                <form action="<%=basePath%>admin/batchDel" method="post" name="form1">
                    ...
                    String tel = request.getParameter("tel");
                        ...
                        int cou = cb.getMessageCount("select count(*) from admin where sf!='管理员' and username like '%"+username+"%' and realname like '%"+realname+"%' and tel like '%"+tel+"%'");//得到信息总数
                        ...
                        List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from admin where sf!='管理员' and username like '%"+username+"%' and realname like '%"+realname+"%' and tel like '%"+tel+"%' order by id desc",9);
