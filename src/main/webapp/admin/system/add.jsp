...
<div id="container">
    <div id="bd">
        <div id="main">
            ...
            <form action="<%=basePath%>admin/addAdmin" method="post">
                <input type="hidden" name="method" value="<%=method%>" /><input type="hidden" name="id" value="<%=id%>" />
                <div class="subfild-content base-info">
                    <div class="kv-item ue-clear">
                        <label>登录账号</label>
                        <div class="kv-item-content">
                            <input type="text" style="width:400px; height:30px;" name="username" value="<%=usernam %>" required/>
                        </div>
                    </div>
                    <div class="kv-item ue-clear time">
                        <label>登录密码</label>
                        <div class="kv-item-content">
                            <input type="password" style="width:400px; height:30px;" name="password" value="<%=password %>" required/>
                        </div>
                    </div>
                    <div class="kv-item ue-clear">
                        <label>真实姓名</label>
                    ...
                    </div><input type="hidden" name="sf" value="教师" />
                <div class="buttons">
