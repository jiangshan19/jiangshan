...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>admin/statics/css/skin_/main.css" />
    <link rel="stylesheet" type="text/css" href="<%=basePath%>admin/statics/css/jquery.dialog.css" />
...
<div id="container">
    ...
    <div id="bd">
        <iframe width="100%" height="100%" id="mainIframe" src="<%=basePath%>admin/nav.jsp" frameborder="0"></iframe>
    </div>
...
<script type="text/javascript" src="<%=basePath%>admin/statics/js/core.js"></script>
<script type="text/javascript" src="<%=basePath%>admin/statics/js/jquery.dialog.js"></script>
<script type="text/javascript">
    ...
    $('.exitDialog input[type=button]').click(function(e) {
        ...
        if($(this).hasClass('ok')){
            window.location.href = "adminExit"	;
        }
    });
